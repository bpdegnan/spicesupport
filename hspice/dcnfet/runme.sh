#!/usr/bin/env zsh
# Run HSPICE nfetdc and save output with hostname suffix
...
PARSER_SCRIPT="hspice_dc_to_csv.py"
...
run_simulation() {
    echo_status "Running HSPICE DC simulation on $HOSTNAME..."
...
plot_comparison() {
    echo_status "Plotting comparison of HSPICE DC CSV files..."
...
case "$MODE" in
    ...
    *)
        ...
        echo ""
        echo "Commands:"
        echo "  run   - Run HSPICE DC simulation and save as nfetdc.gminXX.HOSTNAME.csv"
